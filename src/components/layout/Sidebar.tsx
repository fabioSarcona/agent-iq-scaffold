...
export function Sidebar() {
  ...
  const showNeedAgentIQPanel = location.pathname.startsWith('/audit/') || 
                                 location.pathname === '/moneylost' || 
  ...
  return <aside className="w-80 glass-card border-r border-border/30 flex flex-col animate-fade-in-scale">
      ...
      <div className="flex-1 p-2">
        <div className="space-y-6">
          {/* Show NeedAgentIQ Panel during audit, money lost, and report */}
          {showNeedAgentIQPanel ? <NeedAgentIQPanel /> : <div className="glass-card p-6 rounded-xl border border-dashed border-border/50 text-center hover-lift group">
